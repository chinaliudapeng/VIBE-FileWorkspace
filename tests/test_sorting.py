...
def test_table_sorting():
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        test_db_path = Path(temp_dir) / 'test_workspace_indexer.db'
        ...
        with patch('core.db.get_db_path', return_value=test_db_path):
            ...
            with tempfile.TemporaryDirectory() as temp_dir2:
                ...
                model2.load_workspace_files(None)  # Empty model for final test
